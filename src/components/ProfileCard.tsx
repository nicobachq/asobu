...
function ProfileCard({ profile }: ProfileCardProps) {
  ...
  return (
    <div className="overflow-hidden rounded-[32px] bg-white shadow-sm">
      <div className="h-28 bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-500" />

      <div className="p-5">
        <div className="-mt-16 flex h-28 w-28 items-center justify-center rounded-full border-4 border-white bg-slate-900 text-2xl font-bold text-white shadow-sm">
